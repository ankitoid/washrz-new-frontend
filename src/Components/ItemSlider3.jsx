...
const ItemSlider3 = ({ dryCleanItems, handleClick }) => {
  return (
    <div className="itemslider3-container">
      <Carousel
      ...
      >
        {/* {dryCleanItems?.children?.map((item, index) => (
          <div
            key={index}
            className="slider-item"
            onClick={() => handleClick(item, "DryClean")}
          >
